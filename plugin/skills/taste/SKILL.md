...

{
  ...
  "targetType": "<taste-profile | root-claude-md | project-claude-md | skill-md>",
  "target": "<absolute path when targetType is skill-md or project-claude-md — omit for default>"
}
```
